...
# =========================================================
    ...
    st.subheader("Reemplazar valores NaN con la media")
    df["Edad"]=df["Edad"].fillna(df["Edad"].mean())
    st.dataframe(df)
    # Reemplazar valores nulos y 0 por "Desconocido"
    st.subheader("Reemplazo de valores nulos y 0 en la columna Salario")

    df["Salario"] = df["Salario"].astype(object)
    df["Salario"] = df["Salario"].fillna("Desconocido")
    df["Salario"] = df["Salario"].replace(0, "Desconocido")
...
# =========================================================
    ...
    st.dataframe(df)
# Aplicar transformacion pero en la columna de edad
    ...
    st.subheader("Datos transformados por categorias de edad") 
    st.dataframe(df) 
# =========================================================
